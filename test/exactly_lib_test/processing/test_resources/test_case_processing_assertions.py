...
def accessor_error_matches(error: ValueAssertion[AccessErrorType] = asrt.anything_goes(),
                           error_info: ValueAssertion[ErrorInfo] = result_assertions.error_info_matches()
                           ) -> ValueAssertion[AccessorError]:
    return asrt.is_instance_with__many(
        AccessorError,
        [
