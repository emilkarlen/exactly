...
from exactly_lib_test.test_resources.value_assertions.value_assertion import ValueAssertionBase, MessageBuilder, T


class RaisesHardError(Generic[T], ValueAssertionBase[T]):
...
class RaisesHardErrorAsLastAction(Generic[T], ValueAssertionBase[T]):
