...
class TestIsPass(unittest.TestCase):
    ...
    def test_success_WHEN_actual_is_not_pass(self):
        ...
        cases = [
            NameAndValue('fail',
                         pfh.new_pfh_fail__td(text_docs.single_pre_formatted_line_object('failure msg'))
                         ),
            NameAndValue('fail/const msg',
                         pfh.new_pfh_fail__str('failure msg')
                         ),
            NameAndValue('hard error',
                         pfh.new_pfh_hard_error__td(text_docs.single_pre_formatted_line_object('hard error msg'))
                         ),
    ...
    def test_success_WHEN_actual_is_expected(self):
        ...
        cases = [
            ...
            NEA('fail',
                ...
                pfh.new_pfh_fail__td(text_docs.single_pre_formatted_line_object('fail msg')),
                ),
            NEA('fail/const msg',
                sut.status_is(pfh.PassOrFailOrHardErrorEnum.FAIL),
            ...
            NEA('hard error',
                ...
                pfh.new_pfh_hard_error__td(text_docs.single_pre_formatted_line_object('hard err msg')),
                ),
