...
class StringMatcherSymbolTableValue(SymbolTableValue[StringMatcherStv]):
    @staticmethod
    def of_generic(sdv: GenericStringMatcherSdv) -> 'StringMatcherSymbolTableValue':
        return StringMatcherSymbolTableValue(StringMatcherStv(sdv))

    @staticmethod
    def of_primitive(primitive: StringMatcher) -> 'StringMatcherSymbolTableValue':
        return StringMatcherSymbolTableValue.of_generic(matchers.sdv_from_primitive_value(primitive))
...
class StringMatcherSymbolContext(SdvSymbolContext[StringMatcherStv]):
    def __init__(self,
                 name: str,
                 value: StringMatcherSymbolTableValue,
                 ):
    ...
    def of_sdtv(name: str, sdtv: StringMatcherStv) -> 'StringMatcherSymbolContext':
        return StringMatcherSymbolContext(
            name,
            StringMatcherSymbolTableValue(sdtv)
        )
    ...
    def of_sdv(name: str, sdv: GenericStringMatcherSdv) -> 'StringMatcherSymbolContext':
        return StringMatcherSymbolContext(
            name,
            StringMatcherSymbolTableValue.of_generic(sdv)
        )
    ...
    def of_primitive(name: str, primitive: StringMatcher) -> 'StringMatcherSymbolContext':
        return StringMatcherSymbolContext(
            name,
            StringMatcherSymbolTableValue.of_primitive(primitive)
        )
