...
from exactly_lib.symbol.data import list_resolver, concrete_resolvers
...
from exactly_lib_test.symbol.data.test_resources.concrete_value_assertions import \
    _EqualsSymbolValueResolverBase
