...
from exactly_lib.symbol.data import path_resolvers, list_resolvers
...
class TestEqualsResolver(unittest.TestCase):
    def test_equals__path(self):
        # ARRANGE #
        value = path_resolvers.constant(path_test_impl('file-name'))
        # ACT & ASSERT #
    ...
    def test_not_equals__different_symbol_types(self):
        # ARRANGE #
        expected = path_resolvers.constant(path_test_impl('file-name'))
    ...
    def test_not_equals__path(self):
        # ARRANGE #
        expected = path_resolvers.constant(path_test_impl('expected-file-name'))
        actual = path_resolvers.constant(path_test_impl('actual-file-name'))
        # ACT & ASSERT #
        assert_that_assertion_fails(sut.equals_resolver(expected), actual)
