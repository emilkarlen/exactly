...
import exactly_lib_test.symbol.test_resources.path_relativity
from exactly_lib.test_case_file_structure.path_relativity import PathRelativityVariants, RelOptionType
from exactly_lib_test.symbol.test_resources import path_relativity as sut
...
class TestEqualsPathRelativityVariants(unittest.TestCase):
    def test_equals(self):
        ...
        for variants in test_cases:
            with self.subTest():
                exactly_lib_test.symbol.test_resources.path_relativity.equals_path_relativity_variants(
