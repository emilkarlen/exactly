...
from exactly_lib_test.symbol.test_resources import sdv_type_assertions as sut
...
def arbitrary_sdv_with_references(references: Sequence[SymbolReference]) -> GenericStringMatcherSdv:
