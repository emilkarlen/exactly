...
def is_reference_to_string_made_up_of_just_strings__usage(name_of_symbol: str) -> Assertion[SymbolUsage]:
...
class StringSymbolValueContext(DataSymbolValueContext[StringSdv]):
    ...
    @staticmethod
    def reference_assertion__string_made_up_of_just_strings(symbol_name: str) -> Assertion[SymbolReference]:
        return is_reference_to_string_made_up_of_just_strings(symbol_name)

    @staticmethod
    def usage_assertion__string_made_up_of_just_strings(symbol_name: str) -> Assertion[SymbolUsage]:
...
class StringSymbolContext(DataTypeSymbolContext[StringSdv]):
    ...
    @property
    def reference_assertion__string_made_up_of_just_strings(self) -> Assertion[SymbolReference]:
        return StringSymbolValueContext.reference_assertion__string_made_up_of_just_strings(self.name)

    @property
    def usage_assertion__string_made_up_of_just_strings(self) -> Assertion[SymbolUsage]:
