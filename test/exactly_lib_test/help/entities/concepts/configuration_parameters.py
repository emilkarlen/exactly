...
from exactly_lib_test.help.entities.concepts.test_resources.test_case_impls import \
...
def suite() -> unittest.TestSuite:
    return unittest.TestSuite([
        ...
        suite_for_configuration_parameter_documentation(HOME_CASE_DIRECTORY_CONFIGURATION_PARAMETER),
