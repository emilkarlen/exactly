...
from exactly_lib_test.type_val_prims.string_model.test_resources import assertions as sut, string_models
from exactly_lib_test.type_val_prims.string_model.test_resources.string_models import StringModelThat
