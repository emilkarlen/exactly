...
class LineMatcherResolverConstantTestImpl(LineMatcherResolver):
    def __init__(self, resolved_value: LineMatcher,
                 references: list = ()):
...
IS_LINE_REFERENCE_RESTRICTION = is_value_type_restriction(ValueType.LINE_MATCHER)
