...
from exactly_lib_test.instructions.multi_phase_instructions.define_symbol.common_failing_cases import \
    FAILING_SYNTAX_CASES
from exactly_lib_test.instructions.multi_phase_instructions.define_symbol.test_resources import src
