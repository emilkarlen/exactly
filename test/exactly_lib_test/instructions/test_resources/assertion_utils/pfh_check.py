...
def status_is(expected_status: pfh.PassOrFailOrHardErrorEnum) -> asrt.ValueAssertion[pfh.PassOrFailOrHardError]:
...
def is_pass() -> asrt.ValueAssertion[pfh.PassOrFailOrHardError]:
    return status_is(pfh.PassOrFailOrHardErrorEnum.PASS)


def is_fail(assertion_on_error_message: asrt.ValueAssertion = asrt.is_instance(str)
...
def is_hard_error(assertion_on_error_message: asrt.ValueAssertion = asrt.is_instance(str)
                  ) -> asrt.ValueAssertion[pfh.PassOrFailOrHardError]:
    return asrt.And([
...
def failure_message_is(assertion_on_error_message: asrt.ValueAssertion
                       ) -> asrt.ValueAssertion[pfh.PassOrFailOrHardError]:
