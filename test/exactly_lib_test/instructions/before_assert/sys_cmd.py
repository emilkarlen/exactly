...
from exactly_lib.instructions.before_assert import sys_cmd as sut
...
from exactly_lib_test.instructions.multi_phase.instruction_integration_test_resources.sys_cmd_instruction_test import \
