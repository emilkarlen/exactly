...
from exactly_lib.instructions.multi_phase import sys_cmd as sut
...
from exactly_lib_test.instructions.multi_phase.test_resources.sys_cmd import command_line
