...
from exactly_lib.section_document.parse import PlainDocumentParser
...
class TestSectionsConfiguration(ParseTestBase):
    def test_WHEN_the_default_section_name_is_not_a_name_of_a_section_THEN_an_exception_SHOULD_be_raised(self):
        ...
        sections = [
            exactly_lib.section_document.new_parser_classes.SectionConfiguration(name, InstructionParserForPhase(name))
