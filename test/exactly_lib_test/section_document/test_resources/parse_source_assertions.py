...
def is_at_beginning_of_line(current_line_number: int) -> ValueAssertion[ParseSource]:
...
def is_at_end_of_line(current_line_number: int) -> ValueAssertion[ParseSource]:
    return assert_source(
        has_current_line=asrt.is_true,
        current_line_number=asrt.equals(current_line_number),
