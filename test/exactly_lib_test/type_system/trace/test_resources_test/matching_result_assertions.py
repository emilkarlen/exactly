...
from exactly_lib_test.type_system.trace.test_resources import matching_result_assertions as sut
...
from exactly_lib_test.type_system.trace.test_resources_test.trace_rendering_assertions import NodeRendererForTest
...
class TestAssertionOnRenderer(unittest.TestCase):
    def test_fail(self):
        ...
        renderer_assertion = asrt_trace_rendering.matches_node_renderer(
            rendered_node=asrt_trace.matches_node(header=asrt.equals('expected header'))
        )
    ...
    def test_succeed(self):
        ...
        renderer_assertion = asrt_trace_rendering.matches_node_renderer(
            rendered_node=asrt_trace.matches_node(header=asrt.equals(actual_rendered_node.header))
        )
