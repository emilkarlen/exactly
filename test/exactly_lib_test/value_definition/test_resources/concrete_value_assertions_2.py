...
def value_equals3(expected: SymbolValueResolver) -> asrt.ValueAssertion:
    return _EqualsValue(expected)


def file_ref_value_equals(expected: FileRefResolver) -> asrt.ValueAssertion:
...
def equals_string_value3(expected: StringResolver) -> asrt.ValueAssertion:
