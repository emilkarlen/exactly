...
class _AssertFileRefIsIdenticalToInAutoGeneratedFakeEnvironment(_FileRefAssertionBase):
    ...
    def _check_path_suffix(self,
        ...
        path_suffix = self._expected.path_suffix(sym_tbl)
    ...
    def _get_symbol_table(self) -> SymbolTable:
        ...
        elements = {}
        for ref in self._expected.value_references():
    ...
    def _check_value_references(self,
                                ...
                                message_builder: asrt.MessageBuilder,
                                actual: list):
        assertion = equals_value_references(self._expected.value_references())
