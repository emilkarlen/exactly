...
from exactly_lib.execution.instruction_execution.phase_step_executors import SetupSymbolValidatePreSdsExecutor
...
from exactly_lib_test.value_definition.test_resources import value_definition_utils as vd_tr
...
def _check(put: unittest.TestCase,
    ...
    executor = SetupSymbolValidatePreSdsExecutor(environment)
    # ACT #
