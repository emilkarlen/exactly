...
def matches_hard_error(failure_details: ValueAssertion[Optional[FailureDetails]] =
                       asrt_failure_details.is_any_failure_message()) -> ValueAssertion[ExitCodeOrHardError]:
