...
from exactly_lib_test.execution.full_execution import \
    propagation_of_predefined_timeout_to_phases, \
    propagation_of_predefined_symbols_to_phases, \
...
def suite() -> unittest.TestSuite:
    ...
    ret_val.addTest(propagation_of_predefined_timeout_to_phases.suite())
    ret_val.addTest(propagation_of_predefined_symbols_to_phases.suite())
