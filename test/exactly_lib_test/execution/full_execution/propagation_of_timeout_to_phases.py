...
class Test(unittest.TestCase):
    def test_WHEN_no_instruction_sets_timeout_THEN_the_default_timeout_SHOULD_be_propagated_to_instructions_and_act_phase(
        ...
        recorder_builder = PropertyRecorderBuilder(
            ...
            actual_recordings)
        test_case = _test_case_that_records_for_each_step(recorder_builder)
...
def _test_case_that_records_for_each_step(property_recorder: PropertyRecorderBuilder) -> test_case_doc.TestCase:
