...
from exactly_lib.symbol.data.list_resolver import from_constants
...
EXECUTABLE_FILE_FOR_PY_SRC_AS_ONE_AND_ONLY_ARG = ExecutableFileWithArgs(
    ...
    from_constants([PY_ARG_FOR_EXECUTING_SOURCE_ON_COMMAND_LINE]),
)
