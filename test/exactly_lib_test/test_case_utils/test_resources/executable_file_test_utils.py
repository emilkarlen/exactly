...
class CheckBase(unittest.TestCase):
    ...
    def _assert_passes_validation(self, actual: ExecutableFileWithArgs,
                                  environment: PathResolvingEnvironmentPreOrPostSds):
        validator_util.check(self, actual.validator, environment,
                             validator_util.expect_passes_all_validations())

    def _assert_does_not_pass_validation(self, actual: ExecutableFileWithArgs,
                                         environment: PathResolvingEnvironmentPreOrPostSds):
