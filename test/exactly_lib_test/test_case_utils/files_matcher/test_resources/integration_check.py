...
def check(put: unittest.TestCase,
    ...
    integration_check.check(put, source, model_constructor, parse_files_matcher.files_matcher_parser(), arrangement,
                            LogicValueType.FILES_MATCHER, ValueType.FILES_MATCHER, expectation)
...
def check_with_source_variants(put: unittest.TestCase,
                               ...
                               arrangement: Arrangement,
                               expectation: Expectation):
    integration_check.check_with_source_variants(put, arguments, model_constructor,
                                                 parse_files_matcher.files_matcher_parser(), arrangement,
                                                 LogicValueType.FILES_MATCHER, ValueType.FILES_MATCHER, expectation)
