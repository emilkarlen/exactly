...
from exactly_lib_test.impls.file_properties import FileCheckThatEvaluatesTo
...
class TestValidationShouldBeInPreValidateIfFileDoesExistPreSds(unittest.TestCase):
    def test_successful_validation(self):
        ...
        with tcds_with_act_as_curr_dir() as path_resolving_env:
            ...
            environment = InstructionEnvironmentPreSdsBuilder.of_empty_env(hds=tcds.hds).build
