...
class TestProgramIsExecutedEvenThoughMatcherDoNotAccessModel(configuration.TestCaseBase):
    def runTest(self):
        # ARRANGE #
...
class TestProgramIsExecutedOnceEvenThoughModelIsAccessedMultipleTimes(configuration.TestCaseBase):
    def runTest(self):
        # ARRANGE #
        program_that_outputs_something = pgm_args.program(
            pgm_args.interpret_py_source_line(
