...
from exactly_lib_test.impls.instructions.assert_.test_resources.file_contents.num_lines.utils import \
    TestCaseBase
...
from exactly_lib_test.type_val_deps.types.string.test_resources.string import \
    is_reference_to_string_made_up_of_just_strings__usage, \
    StringSymbolContext
