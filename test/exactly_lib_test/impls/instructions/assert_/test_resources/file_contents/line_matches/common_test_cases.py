...
from exactly_lib_test.impls.types.string_matcher.quant_over_lines import test_resources as tr
from exactly_lib_test.impls.types.string_matcher.test_resources import arguments_building
...
class _TestSymbolReferenceForStringTransformerIsReported(_TestCaseBase):
    def runTest(self):
        ...
        expected_symbol_reference_to_transformer = is_reference_to_string_transformer__usage(lines_transformer_name)
...
class _TestSymbolReferenceForLineMatcherIsReported(_TestCaseBase):
    def runTest(self):
        ...
        expected_symbol_reference_to_transformer = is_reference_to_line_matcher__usage(line_matcher_name)
