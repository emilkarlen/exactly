...
from exactly_lib.impls.instructions.assert_ import stdout as sut
...
from exactly_lib_test.impls.instructions.assert_.test_resources import stdout_stderr
from exactly_lib_test.impls.instructions.assert_.test_resources.stdout_stderr import \
    ProgramOutputInstructionConfiguration
from exactly_lib_test.impls.instructions.assert_.test_resources.stdout_stderr.configuration_for_contents_of_act_result import \
    TestConfigurationForStdFile
from exactly_lib_test.impls.instructions.assert_.test_resources.stdout_stderr.utils import \
