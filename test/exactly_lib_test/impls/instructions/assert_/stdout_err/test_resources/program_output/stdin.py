...
from exactly_lib_test.impls.instructions.assert_.stdout_err.test_resources.abstract_syntax import \
...
class TestStdinCaseBase(TestCaseBase, ABC):
    def _do_check(self,
...
class TestNonEmptyStdinViaExecution(TestCaseBase):
    def runTest(self):
        # ARRANGE #
