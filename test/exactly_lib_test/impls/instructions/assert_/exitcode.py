...
from exactly_lib.impls.instructions.assert_ import exitcode as sut
...
from exactly_lib_test.impls.instructions.assert_.test_resources import instruction_check, expression
from exactly_lib_test.impls.instructions.assert_.test_resources.instruction_check import Expectation, is_pass
