...
from exactly_lib.impls.instructions.before_assert import sys_cmd as sut
...
from exactly_lib_test.impls.instructions.multi_phase.instruction_integration_test_resources.sys_cmd_instruction_test import \
