...
ModelConstructor = Callable[[FullResolvingEnvironment], StringSource]
...
def must_not_be_used(environment: FullResolvingEnvironment) -> StringSource:
...
MODEL_THAT_MUST_NOT_BE_USED = string_sources.string_source_that_must_not_be_used()
