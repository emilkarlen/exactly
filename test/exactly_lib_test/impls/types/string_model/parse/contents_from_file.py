...
from exactly_lib_test.impls.types.string_model.test_resources import integration_check, parse_check
    ...
    def test_without_transformer(self):
        ...
        checker.check__abs_stx__wo_input__std_layouts_and_source_variants(
            ...
            MultiSourceExpectation.of_prim__const(
                asrt_string_model.matches__str__const(
                    src_file.contents,
...
class TestSymbolReferences(unittest.TestCase):
    def runTest(self):
        ...
        string_model_syntax = string_model_abs_stx.TransformedStringModelAbsStx(
        ...
        checker.check__abs_stx__wo_input__std_layouts_and_source_variants(
            self,
            OptionallyOnNewLine(string_model_syntax),
            arrangement_w_tcds(
...
class TestValidation(unittest.TestCase):
    ...
    def test_transformer_SHOULD_be_validated(self):
        ...
        file_string_model_syntax = string_model_abs_stx.StringModelOfFileAbsStx(
        ...
        transformed_string_model_syntax = string_model_abs_stx.TransformedStringModelAbsStx(
            file_string_model_syntax,
            str_trans_syntax,
        )
        ...
        for validation_case in str_trans_validation_cases.failing_validation_cases(str_trans_syntax.symbol_name):
            with self.subTest(validation_case.name):
                ...
                checker.check__abs_stx__wo_input__std_layouts_and_source_variants(
                    self,
                    OptionallyOnNewLine(transformed_string_model_syntax),
                    arrangement_w_tcds(
...
class TestSyntax(unittest.TestCase):
    def test_string_transformer_should_be_parsed_as_simple_expression(self):
        ...
        file_contents_syntax = string_model_abs_stx.TransformedStringModelAbsStx(
            string_model_abs_stx.StringModelOfFileAbsStx(
                src_rel_opt_conf.path_abs_stx_of_name(src_file.name)
            ),
