...
class TestSuccessfulScenariosWithConstantContents(unittest.TestCase):
    def test_string(self):
        ...
        string_model_syntax = string_model_abs_stx.StringModelOfStringAbsStx(string_value)
        # ACT & ASSERT #
...
class TestSymbolReferences(unittest.TestCase):
    def test_just_symbol_reference(self):
        ...
        string_model_syntax = StringModelOfStringAbsStx(
    ...
    def _test_symbol_reference_in_contents(
        ...
        string_model_syntax = StringModelOfStringAbsStx(contents_arguments)
