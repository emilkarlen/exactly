...
from exactly_lib_test.impls.types.string_model.test_resources import integration_check
    ...
    def runTest(self):
        ...
        checker.check__abs_stx__wo_input__std_layouts_and_source_variants(
            ...
            MultiSourceExpectation.of_prim__const(
                ...
                primitive=asrt_string_model.matches__str__const(
                    expected_output,
    ...
    def _test(self,
        ...
        for proc_output_file in ProcOutputFile:
            ...
            for program_case in program_cases:
                ...
                syntax = string_model_abs_stx.StringModelOfProgramAbsStx(
...
class TestFailingValidation(unittest.TestCase):
    def runTest(self):
        ...
        for case in cases:
            ...
            string_source_syntax = string_model_abs_stx.StringModelOfProgramAbsStx(
                ProcOutputFile.STDOUT,
                ...
                with self.subTest(transformation=transformation_case.name,
                    ...
                    checker.check__abs_stx__wo_input__std_layouts_and_source_variants__full_line_parse(
                        ...
                        MultiSourceExpectation.of_const(
                            ...
                            primitive=asrt_string_model.contents_raises_hard_error(
...
class TestNonZeroExitCode(unittest.TestCase):
    ...
    def _check_exit_codes(self,
                          ...
                          expected_primitive: Callable[[str], ValueAssertion[StringModel]],
                          ):
        # ARRANGE #
    ...
    @staticmethod
    def _contents_access_raises_hard_error(contents_on_output_channel: str) -> ValueAssertion[StringModel]:
        return asrt_string_model.contents_raises_hard_error(
            may_depend_on_external_resources=asrt.equals(True)
        )

    @staticmethod
    def _contents_is_output_from_program(contents_on_output_channel: str) -> ValueAssertion[StringModel]:
        return asrt_string_model.matches__str__const(
