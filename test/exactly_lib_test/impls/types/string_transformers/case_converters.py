...
from exactly_lib_test.impls.types.string_transformers.test_resources import case_converters as tr
from exactly_lib_test.impls.types.string_transformers.test_resources import may_dep_on_ext_resources
from exactly_lib_test.impls.types.string_transformers.test_resources.case_converters import CaseConverterConfig
