...
from exactly_lib_test.impls.types.string_matcher.test_resources import contents_transformation, test_configuration
...
from exactly_lib_test.impls.types.string_matcher.test_resources.expectation_utils import \
    expectation_that_file_for_expected_contents_is_invalid
from exactly_lib_test.impls.types.string_matcher.test_resources.relativity_options import \
