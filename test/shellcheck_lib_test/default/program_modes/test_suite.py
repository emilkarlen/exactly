...
from shellcheck_lib_test.test_resources.main_program.main_program_check_for_test_suite import \
    tests_for_setup_without_preprocessor, tests_for_setup_with_preprocessor
from shellcheck_lib_test.test_resources.main_program.main_program_runner import RunViaMainProgramInternally, \
    MainProgramRunner
