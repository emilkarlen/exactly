...
class TestStatementGeneration(TestBase):
    def test_absolute_path_is_unmodified__without_arguments(self):
        with absolute_path_toexecutable_file() as absolute_path:
...
def _contains_single_line(line: str) -> va.ValueAssertion:
    return ContainsSingleLine(va.Equals(line))
