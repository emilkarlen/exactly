...
from exactly_lib.test_case_utils.file_transformer.from_lines_transformer import UniqueFileNameInExistingDirGetter
...
class ResolveFileTransformerFromLinesTransformer(FileTransformerResolver):
    ...
    def resolve(self, named_elements: SymbolTable) -> FileTransformer:
        ...
        if isinstance(lines_transformer, IdentityLinesTransformer):
            ...
            return FileTransformerFromLinesTransformer(UniqueFileNameInExistingDirGetter(),
                                                       lines_transformer)
