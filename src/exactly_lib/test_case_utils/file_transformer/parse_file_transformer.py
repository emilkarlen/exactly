...
class FileTransformerDescriptor(property_description.ErrorMessagePartConstructor):
    def __init__(self, resolver: FileTransformerResolver):
    ...
    def lines(self, environment: InstructionEnvironmentForPostSdsStep) -> list:
        ...
        line = 'TODO: This class should be replaced with  LinesTransformerDescriptor' + str(transformer)
        return [line]
