...
def help_invokation_variants() -> ParagraphItem:
    items = [
        ...
        _item(_help_args(arguments_for.case_specification()),
              'Describes the Test Case functionality.'),
        _item(_help_args(arguments_for.case_cli_syntax()),
        ...
        _item(_help_args(arguments_for.suite_specification()),
              'Describes the Test Suite functionality.'),
        _item(_help_args(arguments_for.suite_cli_syntax()),
