...
ALL_SETUP = (SETUP__VALIDATE_PRE_SDS,
...
ALL_BEFORE_ASSERT = (BEFORE_ASSERT__VALIDATE_PRE_SDS,
...
ALL_ASSERT = (ASSERT__VALIDATE_PRE_SDS,
...
ALL_CLEANUP = (CLEANUP__VALIDATE_PRE_SDS,
               CLEANUP__MAIN)
