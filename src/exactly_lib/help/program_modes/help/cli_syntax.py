...
class HelpCliSyntaxDocumentation(CliProgramSyntaxDocumentation):
    ...
    def synopsises(self) -> list:
        return [
            ...
            _synopsis(_ns(arguments_for.test_case_specification()), 'Describes the test case functionality.'),
            _synopsis(_ns(arguments_for.test_case_cli_syntax()), 'Describes the test case command line syntax.'),
            _synopsis(_ns(arguments_for.test_suite_specification()), 'Describes the test suite functionality.'),
