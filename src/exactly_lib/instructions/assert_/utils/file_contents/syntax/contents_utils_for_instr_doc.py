...
class FileContentsHelpParts:
    def __init__(self,
        ...
        self.file_contents_assertion_help = parts_cl_syntax.FileContentsMatcherHelp(checked_file)
        ...
        format_map = {
            ...
            'file_contents_assertion': syntax_elements.FILE_CONTENTS_MATCHER.argument.name,
        }
    ...
    def invokation_variants(self) -> list:
        return [
            InvokationVariant(self._cls(
                file_contents_assertion.file_contents_assertion_arguments()),
