...
from exactly_lib.instructions.assert_.utils.contents_utils import ActualFileTransformer, parse_actual_file_argument, \
...
class TheInstructionDocumentation(InstructionDocumentationWithCommandLineRenderingBase):
    def __init__(self, name: str):
        self.expected_file_arg = a.Named(contents_utils.RELATIVITY_CONFIGURATION.argument_syntax_name)
        self.actual_file_arg = dt.PATH_ARGUMENT
        super().__init__(name, {
