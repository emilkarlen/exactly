...
class CommandDriverValueForShell(CommandDriverValue):
    ...
    def value_when_no_dir_dependencies(self) -> CommandDriver:
        return commands.ShellCommandDriver(self._command_line.value_when_no_dir_dependencies())

    def value_of_any_dependency(self, home_and_sds: HomeAndSds) -> CommandDriver:
        return commands.ShellCommandDriver(self._command_line.value_of_any_dependency(home_and_sds))
...
class CommandDriverValueForExecutableFile(CommandDriverValue):
    ...
    def value_when_no_dir_dependencies(self) -> CommandDriver:
        return commands.ExecutableFileCommandDriver(self._exe_file.value_when_no_dir_dependencies())

    def value_of_any_dependency(self, home_and_sds: HomeAndSds) -> CommandDriver:
        return commands.ExecutableFileCommandDriver(self._exe_file.value_of_any_dependency(home_and_sds))
...
class CommandDriverValueForSystemProgram(CommandDriverValue):
    ...
    def value_when_no_dir_dependencies(self) -> CommandDriver:
        return commands.SystemProgramCommandDriver(self._program.value_when_no_dir_dependencies())

    def value_of_any_dependency(self, home_and_sds: HomeAndSds) -> CommandDriver:
        return commands.SystemProgramCommandDriver(self._program.value_of_any_dependency(home_and_sds))
