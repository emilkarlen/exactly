...
def instruction_parser(instruction_name_extractor_function: Callable[[str], str],
...
def section_element_parser(instruction_name_extractor_function: Callable[[str], str],
