...
def path_or_symbol_reference(multiplicity: a.Multiplicity, path_argument) -> a.ArgumentUsage:
    return a.Choice(multiplicity, [path_argument, SYMBOL_REFERENCE])
...
def mandatory_path_with_optional_relativity(path_argument: a.Named,
    ...
    if may_use_symbols:
        path_part = path_or_symbol_reference(multiplicity, path_argument)
    return [
