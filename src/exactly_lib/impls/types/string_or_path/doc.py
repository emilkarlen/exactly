...
from exactly_lib.impls.types.path.relative_path_options_documentation import path_elements
...
class StringOrHereDocOrFile:
    def __init__(self,
        ...
        self._expected_file_arg = a.Option(parse_string_or_path.FILE_ARGUMENT_OPTION,
                                           path_name)
