...
class ProgramOutputStringModelSdv(StringModelSdv):
    def __init__(self,
    ...
    def resolve(self, symbols: SymbolTable) -> StringModelDdv:
        ...
        command_source_ddv = ddvs.CommandOutputStringModelDdv(
        ...
        return (
            ddvs.TransformedStringModelDdv(command_source_ddv, program_ddv.transformation)
