...
from exactly_lib.impls.types.path import path_relativities, relative_path_options_documentation
...
EXPECTED_FILE_REL_OPT_ARG_CONFIG = parse_string_or_path.CONFIGURATION
...
def parse(token_parser: TokenParser) -> StringMatcherSdv:
    ...
    expected_contents = parse_string_or_path.parse_from_token_parser(
        token_parser,
