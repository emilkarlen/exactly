...
class _TransformationWriter:
    ...
    def write(self, source: StringSource, output: IO):
    ...
    def _command_processor(self, source: StringSource, output: IO) -> CommandProcessor[ExitCodeAndStderrFile]:
    ...
    def _exit_code_agnostic_processor(self, source: StringSource, output: IO) -> CommandProcessor[
