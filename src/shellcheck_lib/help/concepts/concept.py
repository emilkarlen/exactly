from shellcheck_lib.execution import execution_directory_structure as sds
from shellcheck_lib.execution.environment_variables import ENV_VAR_RESULT_DIR, ENV_VAR_ACT
...
from shellcheck_lib.help.utils.phase_names import CONFIGURATION_PHASE_NAME, phase_name_dictionary
